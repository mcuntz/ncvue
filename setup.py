...
setup(
    ...
    package_data         = {package: ['ncvue/images/*.png',
                                      'ncvue/images/*.ico',
                                      'ncvue/themes/azure-2.0/azure.tcl',
                                      'ncvue/themes/azure-2.0/LICENSE',
                                      'ncvue/themes/azure-2.0/theme/*.tcl',
                                      'ncvue/themes/azure-2.0/theme/dark/*.tcl',
                                      'ncvue/themes/azure-2.0/theme/light/*.tcl',
                                      'ncvue/themes/sun-valley-1.0/sun-valley.tcl',
                                      'ncvue/themes/sun-valley-1.0/LICENSE',
                                      'ncvue/themes/sun-valley-1.0/theme/*.tcl',
                                      'ncvue/themes/sun-valley-1.0/theme/dark/*.tcl',
                                      'ncvue/themes/sun-valley-1.0/theme/light/*.tcl',
                                      ]},
